...
contract GoogleZkAdmin is AccountAdminBase {
    ...
    bytes public constant RSA_E = hex"010001";

    // sha256("5b3706960e3e60024a2655e78cfa63f87c97d309")
    bytes32 public constant RSA_KEY_ID1 =
        hex"e2de8d1d8b4e64dfcba1ec07baca750c9b1eeac480a050316055f37fae14bf7a";
    bytes public constant RSA_N1 =
        hex"";
    // sha256("0e72da1df501ca6f756bf103fd7c720294772506")
    bytes32 public constant RSA_KEY_ID2 =
        hex"fd5e13b316764e193579ba553e91c5ec11c5557777bf8a9403dfdef308bf8519";
    bytes public constant RSA_N2 =
        hex"";

    // sha256("")
    bytes32 public constant OUTPUT_SHA256_MASKED =
        hex"03b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855";
    ...
    function _validateJwtSignature(
        ...
        if (input.kidHash != RSA_KEY_ID1 && input.kidHash != RSA_KEY_ID2) {
            return false;
        }
        if (
            input.kidHash == RSA_KEY_ID1 &&
